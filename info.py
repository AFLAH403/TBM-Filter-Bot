...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002470875163').split()]
...
SUPPORT_CHAT_ID ="-1002470875163"
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://botmakercc:MARANAMASS123@cluster0.7faudo0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002288998123')).split()]
